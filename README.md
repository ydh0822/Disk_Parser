...
- Deferred in this pass: WER dump/CAB extraction, non-text WER payload families, EVTX/SRUM expansion, and cross-artifact incident correlation.
...
- Deferred to the next major feature pass: SRUM v1 and broader cross-artifact semantic correlation.
